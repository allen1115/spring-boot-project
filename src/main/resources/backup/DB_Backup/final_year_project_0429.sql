...
Source Database       : final_year_project

Target Server Type    : MYSQL
Target Server Version : 80011
File Encoding         : 65001

Date: 2018-04-29 00:16:50
*/
...
CREATE TABLE `attendance_threshold_config` (
  ...
  `first_level` double(50,2) DEFAULT NULL,
  `second_level` double(50,2) DEFAULT NULL,
  `third_level` double(50,2) DEFAULT NULL,
...
CREATE TABLE `email_log` (
  ...
  `replied_email_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `is_replied` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0',
...
CREATE TABLE `email_template` (
  ...
  `template_body` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `module` VALUES ('8', 'upload', '/upload', 'authc,roles[admin]', '8');
...
CREATE TABLE `replied_email_log` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `email_subject` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `email_body` varchar(5000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `absence_reason` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `replied_date` datetime DEFAULT NULL,
  `replied_email_log_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `replied_email_log_id` (`replied_email_log_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- Records of student
-- ----------------------------
INSERT INTO `student` VALUES ('1', '805383499@qq.com', 'Allen Shen', 'Computing for Business and Management', 'Active', '3', '63.00', '325866d0bd474389840d7a66773998e1');
